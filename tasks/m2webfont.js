...
module.exports = function(grunt) {
	...
	grunt.registerMultiTask('m2webfont', 'Compile separate SVG files to webfont', function() {
		...
		var o = {
			...
			cssFilePrefixes: options.cssFilePrefixes || wf.cssFilePrefixes,
		...
		function getCssFilePath(stylesheet) {
			var cssFilePrefix = option(o.cssFilePrefixes, stylesheet);
